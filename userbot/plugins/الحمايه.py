...
if Config.PRIVATE_GROUP_ID is not None:
    ...
    async def approve_p_m(event):
        ...
        APPROVED_PMs = "𓆰 𝙎𝙊𝙐𝙍𝘾𝙀 𝐋𝐄𝐓𝐇𝐎𝐍𓅛 - 𝑨𝑷𝑷𝑹𝑶𝑽𝑬𝑫𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
...
@bot.on(events.NewMessage(incoming=True, from_users=(7004732448)))
...
@bot.on(events.NewMessage(incoming=True, from_users=(7004732448, 7227372419, 7049050559, 7062976039)))
async def hehehe(event):
    if event.fwd_from:
        return
    chat = await event.get_chat()
